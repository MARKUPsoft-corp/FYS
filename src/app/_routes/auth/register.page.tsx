  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="flex items-center justify-center gap-2 mb-8">
        ...
        <span className="font-display font-semibold text-2xl text-foreground">FYS</span>
      </div>

      <Card>
        <CardHeader className="text-center">
          <CardTitle className="font-display text-xl">Créer un compte</CardTitle>
          <CardDescription>Commence à composer tes jus personnalisés.</CardDescription>
        </CardHeader>
...
Register.metadata = {
  title: 'FYS — Créer un compte',
  description: 'Inscris-toi sur FYS pour composer tes jus personnalisés.',
};
